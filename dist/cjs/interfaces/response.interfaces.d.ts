...
export type PaginatedPersons = PaginatedResponse<GenericPaginatedData & {
    person: Person[];
}>;
export type PaginatedProjects = PaginatedResponse<GenericPaginatedData & {
    project: Project[];
}>;
export type PaginatedOrganisations = PaginatedResponse<GenericPaginatedData & {
    organisations: Organisation[];
}>;
export type PaginatedFunds = PaginatedResponse<GenericPaginatedData & {
    fund: Fund[];
}>;
export type PaginatedOutcomes = PaginatedResponse<GenericPaginatedData & {
...
export type PaginatedKeyFindings = PaginatedResponse<GenericPaginatedData & {
    keyFinding: KeyFinding[];
}>;
export type PaginatedImpactSummaries = PaginatedResponse<GenericPaginatedData & {
    impactSummary: ImpactSummary[];
}>;
export type PaginatedPublications = PaginatedResponse<GenericPaginatedData & {
    publication: Publication[];
}>;
export type PaginatedCollaborations = PaginatedResponse<GenericPaginatedData & {
    collaboration: Collaboration[];
}>;
export type PaginatedIntellectualProperties = PaginatedResponse<GenericPaginatedData & {
    intellectualProperty: IntellectualProperty[];
}>;
export type PaginatedPolicyInfluences = PaginatedResponse<GenericPaginatedData & {
    policyInfluence: PolicyInfluence[];
}>;
export type PaginatedProducts = PaginatedResponse<GenericPaginatedData & {
    product: Product[];
}>;
export type PaginatedResearchMaterials = PaginatedResponse<GenericPaginatedData & {
    researchMaterial: ResearchMaterial[];
}>;
export type PaginatedFurtherFunding = PaginatedResponse<GenericPaginatedData & {
    furtherFunding: FurtherFunding[];
}>;
export type PaginatedSpinOuts = PaginatedResponse<GenericPaginatedData & {
    spinOut: SpinOut[];
}>;
export type PaginatedDissemination = PaginatedResponse<GenericPaginatedData & {
    dissemination: Dissemination[];
}>;
