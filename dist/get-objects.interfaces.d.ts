import { Collaboration, Dissemination, FilterParamsBase, Fund, FurtherFunding, ImpactSummary, IntellectualProperty, KeyFinding, Organisation, Paginated, Person, PolicyInfluence, Product, Project, Publication, ResearchMaterial, SpinOut } from ".";
/**
 * The objects that can be requested. The enum denotes the api endpoint.
 */
export declare enum GtrObjects {
    PEOPLE = "persons",
    PROJECTS = "projects",
 ...
 */
export declare type GtrObjectsResponseType<T> = T extends "persons" ? PaginatedPersons : T extends "projects" ? PaginatedProjects : T extends "organisations" ? PaginatedOrganisations : T extends "funds" ? PaginatedFunds : never;
/**
 * The map of filters against the enum value of the GetObjects.
 */
export declare type GtrObjectsFiltersType<T> = T extends "persons" ? FilterParamsBase : T extends "projects" ? FilterParamsBase : T extends "organisations" ? FilterParamsBase : T extends "funds" ? FilterParamsBase : undefined;
