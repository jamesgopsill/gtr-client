 ...
 */
export enum GtrAssociatedObjects {
 ...
 */
export type GtrAssociatedObjectsResponseType<T> =
	T extends "persons/_/organisations"
		? PaginatedOrganisations
		: T extends "persons/_/projects"
		? PaginatedProjects
		: T extends "projects/_/organisations"
		? PaginatedOrganisations
		: never

export type GtrAssociatedObjectsFiltersType<T> =
	T extends "persons/_/organisations"
		? FilterParamsBase
		: T extends "persons/_/projects"
		? FilterParamsBase
