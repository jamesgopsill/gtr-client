...
export type GtrObjectResponseType<T> = T extends "persons"
	? Person
	: T extends "projects"
	? Project
	...
	: T extends "funds"
	? Fund
	: T extends "outcomes/keyfindings"
	? KeyFinding
	: T extends "outcomes/impactsummaries"
	? ImpactSummary
	: T extends "outcomes/publications"
	? Publication
	: T extends "outcomes/collaborations"
	? Collaboration
	: T extends "outcomes/intellectualproperties"
	? IntellectualProperty
	: T extends "outcomes/policyinfluences"
	? PolicyInfluence
	: T extends "outcomes/products"
	? Product
	: T extends "outcomes/researchmaterials"
	? ResearchMaterial
	: T extends "outcomes/spinouts"
	? SpinOut
	: T extends "outcomes/furtherfundings"
	? FurtherFunding
	: T extends "outcomes/disseminations"
	? Dissemination
	: never
